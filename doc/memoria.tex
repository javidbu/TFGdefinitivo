...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{graficas/digitos,_curvas_de_decision21-28.ps}
	\caption{Curvas de decisión para los diferentes algoritmos utilizando los valores de los píxeles 21 (x) y 28 (y)}
	\label{fig:digVar1}
\end{figure}

\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{graficas/digitos,_curvas_de_decision29-47.ps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{graficas/titanic,_curvas_de_aprendizaje.ps}
