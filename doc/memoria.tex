...
Por último, vamos a estudiar una base de datos grande, la del bosón de Higgs. Ésta también viene de un concurso del \href{https://www.kaggle.com/c/higgs-boson/data}{Kaggle} celebrado en 2012. Consta de 250000 datos, cada uno con 17 variables primitivas, medidas directamente, y 13 variables derivadas de las anteriores. Muchas entradas de datos tienen variables sin su valor, en esos casos introduciremos un valor nuevo en la variable, que será la media de todos los valores de esa variable.

Lo primero de todo, como la base de datos es bastante grande, es pintar las curvas de aprendizaje, que las tenemos en la gráfica \ref{fig:higgs,_curvas_de_aprendizaje}.
...
En la gráfica \ref{fig:higgs,_curvas_de_aprendizaje} podemos ver cómo tanto el Random Forest como el KNN están sobreajustando los datos. El SVC parece que mejora al utilizar más datos, subiendo hasta 0.1 su valor F1 desde el 10\% de los datos hasta el 100\% de ellos. Tanto el Logistic Regression como el Gaussian NB no mejoran demasiado con más datos, así que utilizaremos sólo el 10\% de ellos, consiguiendo una notable aceleración en el tiempo de cálculo. Si tras el CV vemos que el Random Forest o el KNN dejan de sobreajustar, o que el SVC generaliza bien los datos, nos plantearemos la posibilidad de usar todos los datos para el entrenamiento de los algoritmos.
