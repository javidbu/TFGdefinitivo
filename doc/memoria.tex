...
¿Cómo toma esa línea de decisión? El algoritmo consiste en ir separando los datos en regiones. En cada paso separará una región de los datos en dos, y el criterio de separación es sencillamente disminuir la entropía de las regiones. Para poner un ejemplo, en la gráfica \ref{fig:DecTreeDecLine}, primero separaríamos los datos con la línea 1, consiguiendo una región sin entropía a la derecha de la línea. Luego la línea 2, que parte la región de la izquierda de la línea 1 en dos regiones, deja la región de abajo sin entropía. Con dos líneas más conseguimos separar perfectamente los datos.
...
Vamos a analizar el ejemplo de la gráfica \ref{fig:DecTreeDecLine}. Al principio tenemos una 
