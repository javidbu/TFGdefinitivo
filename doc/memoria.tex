...
\newcommand{\titulo}{Algoritmos de Aprendizaje Automático y sus aplicaciones}
...
A continuación copio literalmente la explicación de cada una de las variables del problema del apartado \ref{sec:higgs}. 
