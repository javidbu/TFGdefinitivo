...
\centering\includegraphics[width=0.4\textwidth]{graficas/titanic3}
\end{abstract}
...
Para solucionar el problema del tratamiento de datos surge el \textit{Machine Learning} (de ahora en adelante \ML), con algoritmos cada vez más potentes capaces de sacar el máximo partido a estos datos. En este trabajo estudiaremos en concreto cinco de ellos, todos de clasificación. Estos cinco son \textit{Logistic Regresion} (LR), \textit{Naïve Bayes} (NB), \textit{Support Vector Machine} (SVM), \textit{Random Forest} (RF) y \textit{K-Nearest Neighbors} (KNN), explicados en detalle en la seccion \ref{sec:alg}.
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{graficas/higgs,_curvas_de_aprendizaje.ps}
