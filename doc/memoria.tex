...
Como vimos en la sección \ref{sec:RandForest}, el Random Forest nos proporciona un método para ver la importancia relativa de las variables. Gracias a ello vemos que las diez variables más importantes para esta base de datos son la 1, 2, 3, 12, 14, 8, 11, 20, 4 y 10, con importancias relativas de 0.1513, 0.1330, 0.0935, 0.0731, 0.0632, 0.0493, 0.0448, 0.0401, 0.0289 y 0.0277. \textbf{RELLENAR NOMBRES DE LAS VARIABLES, ESTAN EN EL EXCEL DE LA CARPETA HIGGS.}
