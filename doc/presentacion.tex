...
\begin{frame}
	\frametitle{Clasificaci\'on vs. Regresi\'on}
		\begin{figure}[htbp]
		\centering
		\subfigure{\includegraphics[width=0.4\textwidth]{NoBiasVariance}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.4\textwidth]{supervisadoDecCurv}}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}[htbp]
	\centering
	\subfigure{\includegraphics[width=0.4\textwidth]{supervisado}}
	\qquad\quad
	\subfigure{\includegraphics[width=0.4\textwidth]{noSupervisado}}
\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Sesgo y varianza}
		\begin{figure}[htbp]
		\centering
		\subfigure{\includegraphics[width=0.35\textwidth]{DatosBiasVariance}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.35\textwidth]{NoBiasVariance}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.35\textwidth]{highBias}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.35\textwidth]{highVariance}}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure{\includegraphics[width=0.35\textwidth]{KNN}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.35\textwidth]{KNN1}}
		\subfigure{\includegraphics[width=0.35\textwidth]{KNN1Overfit}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.35\textwidth]{KNN3}}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure{\includegraphics[width=0.45\textwidth]{sigmoid}}
		\subfigure{\includegraphics[width=0.45\textwidth]{costLogReg}}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure{\includegraphics[width=0.4\textwidth]{highMargin2}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.4\textwidth]{softMargin}}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure{\includegraphics[width=0.4\textwidth]{RandomForest}}
		\qquad\quad
		\subfigure{\includegraphics[width=0.4\textwidth]{DecTreeOverfit}}
	\end{figure}
\end{frame}
